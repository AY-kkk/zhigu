...
const webServers = process.env.E2E_NO_SERVER
  ? undefined
  : [
      {
        ...
        env: {
          ...
          ZHIGU_API_PROXY: process.env.E2E_INTEL_CHAIN ? 'http://127.0.0.1:8099' : 'http://127.0.0.1:8080'
        },
...
if (process.env.E2E_INTEL_CHAIN) {
  webServers.unshift({
