...
func SourceContract() map[string]any {
	return map[string]any{
		...
		"hosts": []string{
			...
			"datacenter-web.eastmoney.com", "web.ifzq.gtimg.cn", "qt.gtimg.cn",
		},
		...
		"kline": map[string]any{
			...
			"note":  "BSE secid uses eastmoney market 0 explicitly, not copied from SZSE board rules. Hosts tried in order on disconnect. If push2his empty-replies: web.ifzq.gtimg.cn fqkline/hkfqkline; A/BSE short history falls back to quotes.sina.cn daily.",
			"fallback": map[string]any{
				"gtimg": "https://web.ifzq.gtimg.cn /appstock/app/fqkline/get and /appstock/app/hkfqkline/get",
				"sina":  "https://quotes.sina.cn/cn/api/json_v2.php/CN_MarketDataService.getKLineData scale=240",
			},
		},
